...
resultados <- lapply(names(longley), function(var_name) {
  stats <- calc_stats(longley[[var_name]])
...
write.csv(combined_df, "medidas_combinadas_longley.csv", row.names = FALSE)
